			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Tambahkan Pengumuman</h3>
						<p> Silahkan menambahkan pengumuman atau promo yang ingin disampaikan kepada Audience </p>
					</div>
					<div class="col-md-8 col-md-offset-2 animate-box">
						
						<form action="pengumumanTambah.php" method="post" enctype="multipart/form-data">
	
							<p>Judul Pengumuman:</p>
							<textarea  rows="3" cols="127" name="judul" style="font-size:11px;"></textarea> <br><br>
							<!-- <input type="text" name="judul"></p> <br><br> -->
							<p>Isi Pengumuman:</p>
							<textarea  rows="15" cols="127" name="isi" style="font-size:11px;"></textarea> <br><br>
							<!-- <input type="text" name="isi"></p><br> -->
							...
							onclick="javascript:document.location='halaman-utama-pengumuman.php'" /> <br><br>
							</div>
