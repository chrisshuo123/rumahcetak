			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p> Silahkan memilih testimoni yang ingin dihapus disini <p>
					</div>
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						
						<table border='1' style="margin-left:auto; margin-right:auto; background-color:#000;" class="table table-bordered">
							...
							while($row = mysqli_fetch_array($result)):
								...
								<!-- FOTO -->
								<?php echo'<td><img name=foto src="data:image/jpeg;base64,'.base64_encode($row['foto']).'" width="250" height="150"></td>'; ?>
								<!-- DELETE BUTTON -->
								<?php 
								echo "<td><a href=deleteTestimoni.php?id=".$row['idTestimoni'].">"; ?>
