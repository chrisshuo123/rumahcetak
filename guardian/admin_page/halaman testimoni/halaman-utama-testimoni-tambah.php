			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p> Silahkan menambahkan testimoni yang ingin ditampilkan pada halaman utama Perusahaan "Rumah Cetak" </p>
					</div>
					<div class="col-md-8 col-md-offset-2 animate-box">
						
						<form action="testimoniTambah.php" method="post" enctype="multipart/form-data">
	
							<p>Nama Pelanggan:</p>
							<textarea  rows="3" cols="127" name="nama" style="font-size:11px;"></textarea> <br><br>
							<!-- <input type="text" name="nama"></p> <br><br> -->
							<p>Testimoni Pelanggan: &nbsp; &nbsp;
							<textarea  rows="15" cols="127" name="testimoni" style="font-size:11px;"></textarea> <br>
							<!-- <input type="text" name="testimoni"></p><br> -->
							...
							<!-- END RUBAH GAMBAR -->
							<!-- <p>Kategori: &nbsp; &nbsp;<input type="text" name="kategori"></p> <br><br> --> <br><br>
