			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p> Silahkan menambahkan tampilan produk baru sesuai dengan kategorinya </p>
					</div>
					<div class="col-md-8 col-md-offset-2 animate-box">
						
						<form action="produkTambah.php" method="post" enctype="multipart/form-data">
							...
							<p style="font-size:12px;">Maks. 100 Karakter</p>
							
							<p>Kategori :</p>
							<div class="form-group">
								<select name="produkdd" class="form-control-2">
								  <option>pilih</option>
								  <?php
								  ...
								  ?>
								  <option value="<?php echo $row["idHeader"]; ?>"><?php echo $row["kategori"]; ?></option>
								  <?php
								  }
								  ?>
								</select> 
							...
							<!--<p><input type="submit" name="submit" value="Tambahkan"></p> <br><br>-->
							...
							onclick="javascript:document.location='produk.php'"/> <br><br><br>
							</div>
						</form>
