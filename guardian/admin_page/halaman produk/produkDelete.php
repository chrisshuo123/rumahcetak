			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Penghapusan Produk</h3>
						<p> Silahkan menghapuskan isi produk yang tidak perlu ditampilkan lagi </p>
					</div>
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						...
						<table border='1' style="margin-left:0%; margin-right:auto; background-color:#000;" class="table table-bordered">
							...
							while($row = mysqli_fetch_array($result)):
								...
								echo "<td>".$row['Isi']."</td>"; ?>
								<td><?php echo'<img name=gambar src="data:image/jpeg;base64,'.base64_encode($row['image']).'" width="250" height="150">'; ?></td>
								<?php
								echo "<td>".$row['kategori']."</td>"; ?>
								<!-- DELETE BUTTON -->
								<?php 
								echo "<td><a href=delete.php?id=".$row['idProduk'].">"; ?>
