			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					...
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
							...
							while($row = mysqli_fetch_array($result)): ?>
								...
								<div class="form-group">
									<select name="alatdd" class="form-control-2" style="width:105%; background-color:#2f3133;">
									  ...
									  // Menunjukkan Pilihan Kategori Produk
									  $res = mysqli_query($link,"select * from header_produk");
									  while($row2=mysqli_fetch_array($res)){
									  ?>
									  <option value="<?php echo $row2["idHeader"]; ?>"><?php echo $row2["kategori"]; ?></option>
									  <?php
									  }
									  ?>
									</select> 
								...
								<td>
								  <label class="btn btn-default btn-file">
								   Ubah <input type="submit" style="display: none;" name="submit" value="update.php">
								  </label>
								</td>
								<!-- END UPDATE BUTTON -->
								</tr>
						...
						onclick="javascript:document.location='produk.php'" /> <br><br>
					</div>
				</div>
			</div>
