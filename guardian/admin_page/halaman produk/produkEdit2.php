			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					...
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						...
						<table border='1' style="margin-left:-15%; margin-right:auto;">
							<tr>
								<td>Judul</td>
								<td>Isi</td>
								<td>Nama Gambar</td>
						...
						<br><br><br><br>
						<button type="button" class="btn" style="font-size:160%; width:35%;" onclick="javascript:document.location='produk.php'">
						<b>Kembali</b>
						</button> <br><br>
					</div>
				</div>
