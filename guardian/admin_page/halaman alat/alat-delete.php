			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Penghapusan Alat</h3>
						<p>Silahkan menghapuskan jenis alat yang tidak perlu ditampilkan</p>
					</div>
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						...
						<table border='1' style="align:center; color:#fff; background-color:#000;" class="table table-bordered">
							...
							<?php
								...
								//fetching data	
								$query = 'SELECT * FROM alat JOIN header_alat WHERE alat.header_alat_idAlat = header_alat.idAlatHeader';
							...
							while($row = mysqli_fetch_array($result)):
								...
								echo "<td>".$row['Isi']."</td>"; ?>
								<!-- GAMBAR -->
								<?php echo'<td><img name=gambar src="data:image/jpeg;base64,'.base64_encode($row['image']).'" width="250" height="150"></td>'; ?>
								<!-- KATEGORI -->
								<?php 
								...
								<!-- DELETE BUTTON -->
								<?php 
								echo "<td><a href=deleteAlat.php?id=".$row['idAlat'].">"; ?>
