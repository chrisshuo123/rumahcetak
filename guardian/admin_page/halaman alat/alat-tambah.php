			...
			<div class="container" style="margin-top: 6%;">
				<div class="row-2">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Penambahan Alat</h3>
						<p> Silahkan menambahkan jenis alat yang ingin ditunjukkan serta menambahkan hasil percetakan produk dari alat 
						yang digunakan sesuai dengan kategori alat tersebut</p>
					</div>
					<div class="col-md-8 col-md-offset-2 animate-box">
						
						<form action="alatTambah.php" method="post" enctype="multipart/form-data">
	
							<p>Jenis alat / hasil percetakan:</p>
							<textarea  rows="3" cols="127" name="judul" style="font-size:11px;"></textarea> <br><br>
							<p>Deskripsi alat / hasil percetakan:</p>
							<textarea  rows="15" cols="127" name="isi" style="font-size:11px;"></textarea> <br><br>
							<!-- KATEGORI -->
							<p>Kategori:</p>
							<div class="form-group">
								<select name="alatdd" class="form-control-2">
								  <option>pilih</option>
								  <?php
								  ...
								  ?>
								  <option value="<?php echo $row["idAlatHeader"]; ?>"><?php echo $row["kategori"]; ?></option>
								  <?php
								  }
								  ?>
								</select> 
							...
							onclick="javascript:document.location='alat-daftar-isi.php'" /> <br><br><br>
