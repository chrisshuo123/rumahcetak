		...
		var g = a(f);
			...
			g.length || (g = e.closest(".alert")),
						 ...
						 b.isDefaultPrevented() || (g.removeClass("in"),
													...
													g.hasClass("fade") ? g.one("bsTransitionEnd", c).emulateTransitionEnd(
...
(jQuery), +function(a){
	...
	c.prototype.to = function(a){
		...
		void 0 : this.sliding ? 
		this.$element.one("slid.bs.carousel", function(){b.to(a)}) : c == a ? 
		this.pause().cycle() : this.slide(a > c ? "next" : "prev", this.$items.eq(a))
	},
	...
	c.prototype.slide = function(b,d){
		...
		var j = f[0],
			k = a.Event("",{relatedTarget : j, direction : h});
...
(jQuery), +function(a){
	...
	var e = ".dropdown-backdrop",
		...
		a(document).on("click.bs.dropdown.data-api", c)
...
(jQuery), +function(a){
	...
	c.prototype.enter = function(b){
		...
		b : a(b.currentTarget).data("bs." + this.type);
		return c || (
		...
		if(this.hasContent() && this.enabled){
			...
			if(j){
				var n = h,
					...
					h = "bottom" == h &&
					k.bottom + m > o.bottom ? "top" : "top" == h && 
					k.top - m < o.top ? "bottom" : "right" == h && 
					k.right + l > o.width ? "left" : "left" == h &&
					k.left - l < o.left ? "right" : h,
	...
	c.prototype.hide = function(b){
		...
		g.isDefaultPrevented() ? void 0 : (
			f.removeClass("in"),
			a.support.transition &&
			f.hasClass("fade") ? 
			f.one("bsTransitionEnd", d).emulateTransitionEnd(c.TRANSITION_DURATION) : d(),
	...
	c.prototype.getViewportAdjustedDelta = function(a, b, c, d){
		...
		if(/right|left/.test(a)){
			var h = b.top - f - g.scroll,
				...
				h < g.top ? 
				e.top = g.top - h : i > g.top + g.height &&
